...
from a secret key. The advantage with the XOR function is that using the same encryption key on the cipher text, restores the
...
Your task has been made easy, as the encryption key consists of three lower case characters. Using\e[1;35m https://projecteuler.net/project/resources/p059_cipher.txt  \e[0m,
