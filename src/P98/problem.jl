...
is remarkable is that, by using the same digital substitutions, the anagram, RACE, also forms a square number: 9216 = 96².
...
Using\e[1;35m https://projecteuler.net/project/resources/p098_words.txt \e[0m, a 16K text file containing nearly two-thousand common English words,
