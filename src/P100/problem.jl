...
random, it can be seen that the probability of taking two blue discs, P(BB) = (15/21)×(14/20) = 1/2.
...
By finding the first arrangement to contain over 10¹² = 1,000,000,000,000 discs in total, determine the number of blue discs
